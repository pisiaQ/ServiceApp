...
public class DeviceRepositoryInFile<T> : IRepository<T> where T : class, IEntity
{
    ...
    public IEnumerable<T> GetAll()
    {
        ...
        {
            using (var reader = File.OpenText("devices.json"))
            {
    ...
    public void Save()
    {
        using (StreamWriter writer = new StreamWriter($"devices.json", false))
        {
